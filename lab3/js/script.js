...
document.addEventListener("DOMContentLoaded", function () {
    let count = Number(localStorage.getItem("quizCount")) || 0;
...
function gradeQuiz() {
    ...
    let answerQ3 = "Jay-Z";
    let answerQ4 = 2000;
    let paulChecked = document.querySelector("#Paul").checked;
    let ringoChecked = document.querySelector("#Ringo").checked;
    let keithChecked = document.querySelector("#Keith").checked;
    let mickChecked = document.querySelector("#Mick").checked;
    ...
    if (paulChecked && ringoChecked && !keithChecked && !mickChecked) {
        ...
        document.querySelector("#markImg5").innerHTML ="<img src='img/xmark.jpg' alt='Incorrect'>";
